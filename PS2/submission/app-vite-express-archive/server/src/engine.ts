import { getAlternateMinutes } from "./alternates.js";
import type { AffectedSegment, TrainServiceAlerts } from "./datamall.js";
import { extractDelayMinutes } from "./delayExtractor.js";
import type { RachelJourney } from "./rachel.js";
...
export function computeCommitPoint(
  ...
  for (const station of journey.stations) {
    ...
    const rerouteTime = getAlternateMinutes(station.code);
...
export function decide(
  ...
  const commitStation = interrupt ? computeCommitPoint(journey, predictedDelayMinutes) : null;
